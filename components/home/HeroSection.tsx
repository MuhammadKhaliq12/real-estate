  ...
  return (
    <div className="relative h-screen flex flex-col items-center justify-center text-white text-center px-4">
      ...
      <div className="flex w-full max-w-2xl justify-start">
        <button className="bg-white text-black px-8 py-2 rounded-t-lg text-[12px]">
          Buy
        </button>
        <button className="bg-[#2c0506] text-white px-8 py-2 rounded-t-lg text-[12px]">
          Sell
        </button>
      </div>

      <div className="w-full max-w-2xl h-18 flex bg-white rounded-b-lg rounded-tr-lg items-center">
        <input
          type="text"
